...
if __name__ == '__main__':
    ...
    if args.vcf:
        ...
        writer = open(args.output+'/sv_count-temp.tsv', 'w')
    ...
    plt.tight_layout()
    plt.savefig(args.output+'/hom_count_sample-wise-temp.png')
    ...
    plt.figlegend(handles, labels, framealpha=1, frameon=True)
    plt.tight_layout()
    plt.savefig(args.output+'/het_count_sample-wise-temp.png')
    ...
    plt.ylim((0, 24000))
    plt.tight_layout()
    plt.savefig(args.output+'/hom_count_population-wise-temp.png')
    ...
    plt.ylim((0, 24000))
    plt.tight_layout()
    plt.savefig(args.output+'/het_count_population-wise-temp.png')