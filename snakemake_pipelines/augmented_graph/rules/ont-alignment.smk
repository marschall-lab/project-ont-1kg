...
rule cram_to_fasta:
    ...
    output:
        fasta=temp('/gpfs/project/projects/medbioinf/users/spani/results/1000GP/augmented_graph/data/fasta/{sample}.fasta.gz'),
        fai=temp('/gpfs/project/projects/medbioinf/users/spani/results/1000GP/augmented_graph/data/fasta/{sample}.fasta.gz.fai'),
        gzi=temp('/gpfs/project/projects/medbioinf/users/spani/results/1000GP/augmented_graph/data/fasta/{sample}.fasta.gz.gzi')
    conda:
        "../envs/basic.yml"
    resources:
        runtime_hrs=20,
